 ...
 * @param {string|number} props.metric.value - Metric value
 * @param {string} props.metric.icon - Icon name from iconMap
 * @param {Object} [props.metric.change] - Optional change data
 * @param {string} [props.metric.description] - Optional description
 * @param {string} [props.className] - Additional CSS classes
 * @param {Object} [props.style] - Inline styles for animations
